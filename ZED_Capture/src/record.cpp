//
// Created by lacie on 25/04/2023.
//
...
{
    save_folder = std::string("/home/lacie/Documents/ZED_native/" + getDateTime());
...
void getImagesThreadFunc()
{
    ...
    else std::cout << "Encode buffer empty \n";
    ...
    std::cout << save_folder << "\n";
    std::cout << image_csv_path << "\n";
    std::cout << imu_csv_path << "\n";
